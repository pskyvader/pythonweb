...
class backup(base):
        ...
        if file is not None:
            ...
            if zipfile.is_zipfile(file):
                ...
                for i in range(inicio, total):
                    ...
                    if i % 500 == 0 or functions.current_time(as_string=False) - tiempo > 0.3:
                        log_file = {
                            "mensaje": "Restaurando ..."
                            + nombre[-30:]
                            + " ("
    ...
    def eliminar(self):
        ...
        if os.access(self.dir_backup + "/" + file, os.W_OK) is not True:
            respuesta[
                "mensaje"
            ] = "Debes dar permisos de escritura o eliminar el archivo manualmente"
        else:
    ...
    def zipData(self, source, destination, lista, total=1, log=True):
        ...
        for file in lista.copy():
            ...
            if log and (
                functions.current_time(as_string=False) - tiempo > 5
                or count % 1000 == 0
            ):
                log_file = {
                    "mensaje": "..."
